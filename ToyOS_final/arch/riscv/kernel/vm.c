...
void setup_vm_final(void) {
    ...
    create_mapping(swapper_pg_dir,(uint64)(&_stext),(uint64)(&_stext)-PA2VA_OFFSET,(uint64)(&_srodata)-(uint64)(&_stext),5);
    ...
    create_mapping(swapper_pg_dir,(uint64)(&_sdata),(uint64)(&_sdata)-PA2VA_OFFSET,(uint64)(&_sbss)-(uint64)(&_sdata),3);
    
    // mapping other memory -|W|R|V
    create_mapping(swapper_pg_dir,(uint64)(&_sbss),(uint64)(&_sbss)-PA2VA_OFFSET,(uint64)(VM_START+PHY_SIZE)-(uint64)(&_sbss),3);
    ...
    create_mapping(swapper_pg_dir,uapp_start+PA2VA_OFFSET,(uint64)(uapp_start),(uint64)(uapp_end)-(uint64)(uapp_start),7);
...
void create_mapping(uint64 *pgtbl, uint64 va, uint64 pa, uint64 sz, int perm) {
    ...
    while((int)(sz)>0){
        ...
        if((pmtbl[index3]&1)!=1){
            pmtbl[index3]=(pa>>12<<10)+(perm<<1)+1;
            pa+=0x1000;
            va+=0x1000;
            sz-=0x1000;
            //flag++;
